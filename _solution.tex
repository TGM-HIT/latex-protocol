...
\verb|landscape| & Richte das Dokument vertikal aus.\\
\verb|minted| & Nutze das \texttt{minted} Paket zur Quelltextdarstellung.\\
\verb|natbib| & Nutze NatBib zur Literaturverwaltung.\\
\verb|nobib| & Deaktiviere die Literaturverwaltung.\\
\verb|nofonts| & Nutze die Standard \LaTeX ~Schriftarten.\\
\verb|noglo| & Deaktiviere Akronyme und das Glossar.\\
\verb|nologo| & Zeichne keine Logos auf der Titelseite.\\
\verb|notitle| & Zeichne keine Titelseite.\\
\verb|notoc| & Zeichne kein Inhaltsverzeichnis.\\
\verb|notable| & Zeichne keine Tabelle auf der Titelseite.
\end{tabularx}
