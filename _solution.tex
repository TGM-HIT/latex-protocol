...
\ifminted   \codeline{tex}{\myvariable{value}}
\else       \codeline{tex}{\\myvariable{value}}\fi  % Escape \ for lstlistings
...
\begin{listing}
\ifminted   \codeline[linenos=true]{tex}{\begin{code}[]{java}}  % Escape \ for lstlistings
\else       \codeline[numbers=left]{tex}{\\begin\{code\}[]\{java\}}\fi
...
\end{code}
\ifminted   \codeline[firstnumber=last, linenos=true]{tex}{\end{code}}  % Escape \ for lstlistings
\else       \codeline[firstnumber=last, numbers=left]{tex}{\\end\{code\}}\fi
...
\ifminted   \codeline{tex}{\codeline[options]{lang}{code}}  % Escape \ for lstlistings
\else       \codeline{tex}{\\codeline[options]\{lang\}\{code\}}\fi
eingefügt werden.

\subsubsection{Listings}
\begin{listing}
\ifminted   \codeline[linenos=true]{tex}{\begin{lstlisting}[language=Java, caption=Java Lstlisting]}
\else       \codeline[numbers=left]{tex}{\\begin\{lstlisting\}[language=Java, caption=Java Lstlisting]}\fi
\begin{code}[firstnumber=last]{java}
// Ich bin ein Kommantar!
public static void main(String[] args) {
    System.out.println("Ich bin ein Array!")
...
\end{code}
\ifminted   \codeline[firstnumber=last, linenos=true]{tex}{\end{lstlisting}}
\else       \codeline[firstnumber=last, numbers=left]{tex}{\\end\{lstlisting\}}\fi
...
\paragraph{Umgebung}~\\
\begin{listing}
\ifminted   \codeline[linenos=true]{tex}{\begin{minted}[options]{java}}
\else       \codeline[numbers=left]{tex}{\\begin\{minted\}[]\{java\}}\fi
\begin{code}[firstnumber=last]{java}
// Ich bin ein Kommantar!
public static void main(String[] args) {
    System.out.println("Ich bin ein Array!")
...
\end{code}
\ifminted   \codeline[firstnumber=last, linenos=true]{tex}{\end{minted}}
\else       \codeline[firstnumber=last, numbers=left]{tex}{\\end\{minted\}}\fi
...
\paragraph{Zeile}~\\
\begin{listing}
\ifminted   \codeline{tex}{\mint[options]{lang}|code|}
\else       \codeline{tex}{\\mint[options]{lang}|code|}\fi
